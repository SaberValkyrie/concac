...
namespace HealthInsurance.Controllers
{
    public class PoliciesController : Controller
    {
        ...
        {
            return _context.PoliciesEmps != null ?
                        View(await _context.PoliciesEmps.ToListAsync()) :
        ...
        public async Task<IActionResult> Buy(int? id)
        {
            var policy = await _context.PoliciesEmps.FirstOrDefaultAsync(p => p.PolicyId == id);
        ...
        public async Task<IActionResult> Buy(PoliciesReqDetail model)
        {
            ...
            var policy = await _context.PoliciesEmps.FirstOrDefaultAsync(p => p.PolicyId == model.PolicyId);
